...
public:
	...
	void Render(Shader* shader, const Vector2& pos, const Vector2& scale, const Vector2& texPos, const Vector2& size, const Vector2& center = Vector2::ZERO, const float angle = 0.0f, const Vector4 color = Vector4::ONE);
